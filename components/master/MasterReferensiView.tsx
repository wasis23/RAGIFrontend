...
export function MasterReferensiView({
  ...
  const tipeColumns: ColumnDef<MasterTipeReferensi>[] = [
    ...
    },
    {
      ...
      align: 'left',
      render: (row) => (
        <span className="font-mono font-bold text-xs text-slate-700 bg-slate-100 border border-slate-200 px-2.5 py-1 rounded-lg">
          {row.kode}
        </span>
      ),
    },
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 bg-slate-100 p-2 rounded-xl border border-slate-200">
              <button
                type="button"
                    ...
                    <button
                      ...
                      className={`px-3 py-2 text-xs font-semibold rounded-lg transition-all ${
                        isSelected
                          ...
                          : 'bg-slate-100 text-slate-600 hover:bg-slate-200/70 border border-slate-200/70'
                      }`}
