          ...
          <div className="modal modal-lg modal-body">
                    ...
                    <div className="space-y-2 pt-1">
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="text-[11px] font-bold text-slate-700 hover:text-primary-900 underline"
                        >
                          ...
                          return (
                            <div
                              ...
                              className={`flex items-center justify-between p-2.5 rounded-xl border cursor-pointer text-xs transition-all ${
                                isChecked
                                  ? 'bg-white border-primary-600 shadow-2xs ring-1 ring-primary-600/30'
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-4 border-t">
                ...
                <button type="submit" disabled={submitting} className="btn btn-primary btn-sm font-bold border-none">
            ...
            <div className="p-6 border border-slate-300 rounded-xl bg-white space-y-6 text-slate-900 leading-relaxed shadow-xs">
              ...
              <div className="grid grid-cols-2 gap-4 text-xs bg-slate-50 p-4 rounded-xl border border-slate-200">
                ...
                <div>
                  ...
                  <span className="badge badge-green inline-block mt-0.5">
              ...
              <div className="pt-6 border-t grid grid-cols-2 text-xs text-center">
                ...
                <div>
                  ...
                  <div className="h-12 flex items-center justify-center text-slate-700 font-mono text-[10px]">
