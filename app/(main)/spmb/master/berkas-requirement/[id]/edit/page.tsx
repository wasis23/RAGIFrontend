...
export default function EditBerkasRequirementPage() {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      setLoading(true);
      await spmbService.updateBerkasRequirement(id, data);
      toast.success('Syarat berkas berhasil diperbarui');
  ...
  return (
    <div className="animate-fade-in flex flex-col gap-6">
      <PageHeader
        ...
        description="Perbarui persyaratan dokumen untuk pendaftaran"
        action={
          <Button 
            variant="outline" 
